...
public class StaticData : Singleton<StaticData>
{
    ...
    void InitMonsters()
    {
        m_Monsters.Add(0, new MonsterInfo() { ID = 0, Hp = 5, MoveSpeed = 25f, Price = 1 });
        m_Monsters.Add(1, new MonsterInfo() { ID = 1, Hp = 5, MoveSpeed = 20f, Price = 2 });
        m_Monsters.Add(2, new MonsterInfo() { ID = 2, Hp = 15, MoveSpeed = 40f, Price = 5 });
        m_Monsters.Add(3, new MonsterInfo() { ID = 3, Hp = 20, MoveSpeed = 40f, Price = 10 });
        m_Monsters.Add(4, new MonsterInfo() { ID = 4, Hp = 20, MoveSpeed = 40f, Price = 15 });
        m_Monsters.Add(5, new MonsterInfo() { ID = 5, Hp = 100, MoveSpeed = 10f, Price = 20 });
    }
